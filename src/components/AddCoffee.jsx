...
const AddCoffee = () => {
   ...
   const handleAddCoffee = event => {
    ...
    // data send to server
    fetch('https://coffee-store-server-ten-beta.vercel.app/coffee', {
        method: 'POST',
        headers: {
        ...
        <div className="" style={{backgroundImage: `url("https://i.ibb.co.com/xCkyX6N/11.png")`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat'}}>
          ...
          <div className="container mx-auto px-6 md:px-10 lg:px-14  pb-16 md:pb-32">
            <div className="bg-[#F4F3F0] rounded-md py-8 md:py-16 px-6 md:px-20 lg:px-28">
                <h3 className="text-[45px] rancho text-[#374151] mb-8 text-center">Add New Coffee</h3>
                ...
                <input type="text" name="photo" placeholder="Enter photo URL" className="input      input-bordered" required />
                    ...
                    <input className="text-2xl text-[#331A15] rancho btn btn-block bg-[#D2B48C] border-2 border-[#331A15]" type="submit" value="Add coffee" />
                </form>
